...
{red}
    ...
    ███▄  █▄   ▄▀ █  █ █  █  █▄   ▄▀ █  █  
         ▀ ▀███▀      █   █   ▀███▀   ███▀  
                    █   ▀                  
                   ▀                                          
                                      \033[1;32mCoded By : ./Itingss 
                                           V : 3.1.2
                                       Team : Jawa Barat Eror Network 
                                  \033[1;33mhttps://github.com/Itingssss
""")
time.sleep(0.5)
...
print(f"""{yellow}┌─────────────────────────────────────────────────────────────────────────────────────────────────┐{blue}
{yellow}│{blue} [01] Dump V3 {red}[Hot Results]{blue}                               [11] Homework [Only For Homework]         {yellow}│{blue}
{yellow}│{blue} [02] DUMP V2                                            [12] Executor {red}[Hot Results]{blue}               {yellow}│{blue}
{yellow}│{blue} [03] DUMP V1                                    [13] Ping Site                            {yellow}│{blue}
...
if answer == ("1"):
    ...
    print('')
    print('                  python3 maung.py -h untuk Mulai                    ' + Style.RESET_ALL)
    print("-" * 73)
...
if __name__ == "__main__":
    try:
        ...
        print(fail + '\nSyntax - python3 maung.py -t <domain>\n')
...
try:
    ...
    print("Usage : python3 maung.py -s {site} -f {file extension type}")
print ("Done...")
